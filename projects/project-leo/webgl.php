...
<html>
    ...
    <body>
        <style>
            .header-background {
                background-image: linear-gradient(rgba(5, 18, 70, 0.7), rgba(59, 4, 70, 0.7)), url("<?=VFX?>/Blue-Nebula-8-1024x1024-1.png");
                padding: 1% 0;
            }
            ...
            * { cursor: pointer; }
            ...
            footer {
                background: linear-gradient(rgba(5, 18, 70, 0.7), rgba(59, 4, 70, 0.7)), url("<?=VFX?>/Blue-Nebula-8-1024x1024-1.png");
            }
