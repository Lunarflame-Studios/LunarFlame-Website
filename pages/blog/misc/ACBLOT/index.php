    ...
    <div class="background">
        ...
        <section class="page-body">
            ...
            <div class="blog-pageBody">
                ...
                <img class="page-image gallery-img offset-border purple" id="image" src="images/blog/C_programming.png" alt="">
                <div>
                    <h2>Why Learn C?</h2>
            ...
            <div class="image-container">
                <img class="page-image gallery-img" id="image" src="https://drive.google.com/thumbnail?id=17hbpdpeXZlP5Ci9bnZ1xv0fEVtEY04Yr&sz=w1000">
            </div>
            ...
            <hr class="blog-end">            <?php require('../../../partials/recent-posts.php') ?>
        </section>
