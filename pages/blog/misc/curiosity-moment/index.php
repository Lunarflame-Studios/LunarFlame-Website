        ...
        <section class="page-body">
            ...
            <div class="blog-pageBody">
                ...
                <div>
                    ...
                    <p class="margin-top">Some video games can capture and define their own unique identity through visuals, artwork, and music. Doing so makes the themes and motifs of the game more memorable. Animation and graphics can bring worlds to life and create detailed characters that may not be as easy to portray through just words.</p>
                </div>
                <hr>
                ...
                <div>
                    ...
                    <br>
                    <p>Ori and the Blind Forest takes place in the forest of Nibel, which is withering away without the influence of its great Spirit Tree. Ori, a guardian spirit, fell from the tree as a newborn and was taken in by a creature named Naru, who raised Ori as her own. The decaying of the Great Tree causes a famine in the forest, and Naru dies of starvation to feed her child. Afterwards, Ori meets a small spirit named Sein, who guides Ori on a journey to restore the forest.<br>
                        <br>The sequel, Will of the Wisps, takes place in the forest of Niwen, where Ori and his owl friend Ku have been stranded and separated after an accident in a storm. Like Nibel, Niwen is in decay after the deterioration of its great tree. Ori must traverse and restore the land of Niwen in order to rescue Ku.
                    </p>
                    <br>
                    <div id="full-width" class="scroll-container">
